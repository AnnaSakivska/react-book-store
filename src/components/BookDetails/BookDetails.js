...
const BookDetails = observer(({ stores }) => {
  const { id } = useParams();
  ...
  // const fetchSpecificBook = useCallback(async() => {
  //   // await stores.bookDetailsStore.fetchBookDetails(userToken, id);
  //
  //   // console.log(stores.bookDetailsStore.getBookDetails())
  // }, [userToken, id])

  // useEffect( () => {
  //   // await stores.bookDetailsStore.fetchBookDetails(userToken, id);
  //   const data = fetchSpecificBook()
  //   console.log(data)
  // }, [fetchSpecificBook]);
...
export default inject('stores')(BookDetails);
